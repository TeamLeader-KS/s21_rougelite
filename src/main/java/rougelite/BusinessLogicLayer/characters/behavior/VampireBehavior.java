...
public class VampireBehavior implements EnemyBehavior {
    ...
    public void receivingDamage(Enemy enemy, int damage) {
        ...
        System.out.println("💥 Вампир получил урон: " + damage + " (было: " + healthBefore + ", стало: " + enemy.getHealth() + ")");
        if (!enemy.isAlive()) {
            System.out.println("☠️ Вампир уничтожен!");
        }
    }
